...
class BdevsTimeline extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Timeline', 'bdevs-elementor' );
	}

	/**
	 * Get widget icon.
	 *
	 * Retrieve Bdevs Timeline widget icon.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	 ...
	 *
	 * Retrieve the list of categories the Bdevs Timeline widget belongs to.
	 *
	 * @since 1.0.0
	 * @access public
	 *
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Timeline', 'bdevs-elementor' ),
			]	
		);
        ...
        <div class="timeline-image">
            ...
            <div class="intro-years">
                ...
                <h3 class="facts-counter-number">
                    <?php print wp_kses_post($settings['number']); ?>
                </h3>
                <!-- section title end -->
                <!-- section subtitle start -->
                <h4>
                    <?php print wp_kses_post($settings['subtitle']); ?>
                </h4>
                <!-- section subtitle end -->
            </div>
            <!-- intro end -->
