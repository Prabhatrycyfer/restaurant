...
final class BdevsElementor {
	...
	public function admin_notice_missing_main_plugin() {
		...
		$message = sprintf(
			...
			'<strong>' . esc_html__( 'Foodex Elementor', 'bdevs-elementor' ) . '</strong>',
	...
	public function add_elementor_category() {
    	\Elementor\Plugin::instance()->elements_manager->add_category('bdevs-elementor',
	      	array(
					'title' => __( 'Foodex Elementor', 'bdevs-elementor' ),
					'icon'  => 'fa fa-plug',
	      	) 
	    );
	}
	...
	*/
	...
	public function init_widgets() {
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/slider-01-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/slider-02-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/about-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/skill-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/gallery-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/team-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/contact-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/maps-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/menu-widget.php';
		...
		require_once plugin_dir_path( __FILE__ ) . 'widgets/timeline-widget.php';
		require_once plugin_dir_path( __FILE__ ) . 'widgets/video-widget.php';


		// Register widget
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsSlider01() );

		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsSlider02() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsMenu() );
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \BdevsElementor\Widget\BdevsMaps() );
