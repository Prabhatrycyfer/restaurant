                                    ...
                                    <div class="swiper-slide-inner-txt">
                                        ...
                                        <a href="#">
                                            <h2 class="hero-subheading hero-subheading-home fadeIn-element introduction">
                                                <span>  <?php if(isset($foodex_redux_demo['blog_subtitle'])){?>
                                                        <?php echo wp_specialchars_decode(esc_attr($foodex_redux_demo['blog_subtitle']));?>
                                                        <?php }else{?>
                                                        <?php echo esc_html__( 'In The News', 'foodex' );
                                                        }
                                                        ?></span>
                                            </h2>
                                        </a>
                                        ...
                                        <h1 class="hero-heading hero-heading-home fadeIn-element introduction">
                                            <?php if(isset($foodex_redux_demo['blog_title'])){?>
                                            <?php echo wp_specialchars_decode(esc_attr($foodex_redux_demo['blog_title']));?>
                                            <?php }else{?>
                                            <?php echo esc_html__( 'Our Blog', 'foodex' );
                                            }
                                            ?>                                           
                                        </h1>
                                        <!-- section title end -->
