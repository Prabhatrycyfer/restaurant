                                ...
                                <div class="swiper-slide-inner">
                                    ...
                                    <div class="swiper-slide-inner-txt">
                                        ...
                                        <h1 class="hero-heading hero-heading-home fadeIn-element introduction">
                                            <?php printf( esc_html__( 'Search Results for : %s', 'foodex' ), get_search_query() ); ?>                                
                                        </h1>
                                        <!-- section title end -->
                                    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
              <div class="search-custom" >
                ...
                echo esc_html__( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'foodex' ) ;?>
                </h4>
                <?php get_search_form();?>
              </div>
