                                ...
                                <div class="swiper-slide-inner">
                                    ...
                                    <div class="swiper-slide-inner-txt">
                                        ...
                                        <h1 class="hero-heading hero-heading-home fadeIn-element introduction">
                                            <?php
                                              if ( is_day() ) :
                                                  printf( esc_html__( 'Daily Archives : %s', 'foodex' ), get_the_date() );
                                              elseif ( is_month() ) :
                                                  printf( esc_html__( 'Monthly Archives: %s', 'foodex' ), get_the_date( _x( 'F Y', 'monthly archives date format', 'foodex' ) ) );
                                              elseif ( is_year() ) :
                                                  printf( esc_html__( 'Yearly Archives: %s', 'foodex' ), get_the_date( _x( 'Y', 'yearly archives date format', 'foodex' ) ) );
                                              else :
                                                  echo esc_html__( 'Archives', 'foodex' );
                                              endif;
                                            ?>                                            
                                        </h1>
                                        <!-- section title end -->
