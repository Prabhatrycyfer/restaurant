<?php $foodex_redux_demo = get_option('redux_demo');?> 
    ...
    <section id="footer" class="section-all bg-light">
        <div class="row footer-credits">
            <?php if(isset($foodex_redux_demo['footer_logo_dark']['url']) && $foodex_redux_demo['footer_logo_dark']['url'] != ''){ ?>
            <!-- footer logo start -->
            <div class="footer-credits-logo">
                <a href="<?php echo esc_url(home_url('/')); ?>"><img alt="Logo" src="<?php echo esc_url($foodex_redux_demo['footer_logo_dark']['url']); ?>"></a>
            </div>
            <!-- footer logo end -->
            <?php }else{ ?>
            <div class="footer-credits-logo">
