                ...
                <div class="navbar-header fadeIn-element">
                    ...
                    <div class="logo">
                        <a class="navbar-brand logo" href="<?php echo esc_url(home_url('/')); ?>">
                            ...
                            <?php if(isset($foodex_redux_demo['logo_dark']['url']) && $foodex_redux_demo['logo_dark']['url'] != ''){ ?>
                            <!-- logo light start -->
                            <img alt="Logo" class="logo-dark" src="<?php echo esc_url($foodex_redux_demo['logo_dark']['url']); ?>">
                            <!-- logo light end -->
                            <?php }else{ ?>
                            <img alt="Logo" class="logo-dark" src="<?php echo get_template_directory_uri();?>/img/logo-dark.png">
                            <?php } ?>
                        </a>
                    </div>
                    <!-- logo end -->
